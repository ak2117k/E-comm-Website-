          ...
          <div className="">
            ...
            >
              <rect
                ...
                stroke-width="2"
              />
              <rect x="0" y="0" width="60" height="60" fill="#FFE998" />
              <rect x="65" y="0" width="60" height="60" fill="#FFE998" />
              <rect x="130" y="0" width="60" height="60" fill="#FFE998" />
              <rect x="0" y="65" width="60" height="60" fill="#FFE998" />
              <rect x="65" y="65" width="60" height="60" fill="#FFE998" />
              <rect x="130" y="65" width="60" height="60" fill="#FFE998" />
              <rect x="0" y="130" width="60" height="60" fill="#FFE998" />
              <rect x="65" y="130" width="60" height="60" fill="#FFE998" />
              <rect x="130" y="130" width="60" height="60" fill="#FFE998" />
            </svg>
          </div>
          <div className="font-semibold">Hey! your wishlist is empty</div>
          <div className="text-gray-400">
            Save items in your wishlist. Review and easily move them to your
            bag.
          </div>
          <Link to={"/"}>
